...
(function() {
  ...
  function makeBullet() {
    ...
    geometry.vertices.push(new THREE.Vector3(-0.5, rand - 0.5, (1 + Math.random()) * -30));
    geometry.vertices.push(new THREE.Vector3( 0.5, 0.5 - rand, (1 + Math.random()) * -30));   // 2d = all vertices in the same plane.. z = 0
